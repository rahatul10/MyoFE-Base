...
cd ../../../python_codes
singularity exec --cleanenv /home/ris237/fenics.img  mpiexec -np $SLURM_NTASKS  python MyoFE.py LV_sim /home/ris237/MyoFE/demos/growth_FR/AS/input_parameters_AS_nofr.json
